...
namespace Bicep.Core.Semantics
{
    public sealed class DeclarationVisitor : SyntaxVisitor
    {
        ...
        public override void VisitLambdaSyntax(LambdaSyntax syntax)
        {
             ...
             */
            if (syntax.Variable is {} itemVariable)
            {
                var itemVariableSymbol = new LocalVariableSymbol(this.context, itemVariable.Name.IdentifierName, itemVariable, LocalKind.LambdaItemVariable);
